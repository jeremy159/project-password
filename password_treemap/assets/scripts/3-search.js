...
function search(map, g, districtId, bound, showPanel) {
  /* Effectuer un zoom en utilisant la fonction "fitBounds" de Leaflet en respectant les contraintes suivantes:
   ...
   */
   ...
   map.fitBounds(bound, { maxZoom: 8, animate: true, pan: { duration: 1, easeLinearity: 0.5 } });
